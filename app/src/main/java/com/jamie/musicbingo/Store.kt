...
class Store : AppCompatActivity(), PurchasesUpdatedListener {
    ...
    private lateinit var electroIcon: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        popButton = findViewById(R.id.buy_pop)
        rockButton = findViewById(R.id.buy_rock)
        countryButton = findViewById(R.id.buy_country)
        electronicButton = findViewById(R.id.buy_elect)
        rapButton = findViewById(R.id.buy_rap)
