...
import com.jamie.musicbingo.data.HistoryDialog
...
class Profile : AppCompatActivity() {
    ...
    lateinit var username_field: TextView
    lateinit var email_field: TextView
    lateinit var country_field: TextView
    lateinit var follower_field: TextView
    lateinit var scoreField: TextView
    lateinit var lineField: TextView
